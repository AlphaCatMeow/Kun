...
export function addUsage(into: UsageSnapshot, delta: UsageSnapshot): UsageSnapshot {
  ...
  return {
    ...
    cacheMissTokens,
    cacheHitRate,
    cacheableTokenHitRate: delta.cacheableTokenHitRate,
    totalInputTokenHitRate: delta.totalInputTokenHitRate,
    cacheMissReasons: delta.cacheMissReasons,
    cacheSuggestions: delta.cacheSuggestions,
    turns,
    costUsd,
    costCny,
    cacheSavingsUsd,
